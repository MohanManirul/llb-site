...
return [
    ...
    */
    ...
    // Sits under the Settings → System Monitoring section it is reached from.
    'route_path' => 'system-monitoring/log-viewer',
    ...
    */
    ...
    // The viewer is reached from Settings → System Monitoring, so send the user
    // back into the app rather than to the site root.
    ...
    */
    ...
    // `auth:sanctum` sends a guest to /login instead of a bare 403 page. The
    // gate below (viewLogViewer) then limits it to the super-admin.
    'middleware' => [
        'web',
        'auth:sanctum',
